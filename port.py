...
async def port_scan_async(target, start_port=1, end_port=4000, timeout=.4):
    open_ports = []
...
if __name__ == "__main__":
    print(f"\n{Fore.WHITE}🔍 Welcome to JettyPort! Check out the Creator at https://github.com/AnonCatalyst 🔍{Style.RESET_ALL}")
